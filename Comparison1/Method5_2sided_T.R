...
calc_pwr_conj_test_2sided_T <- function(K,            # Number of clusters in treatment arm
  ...
  if(dist == "T"){ # Using T-distribution
    ...
    stop("Please choose a valid input parameter for 'dist', i.e. 't' for t-Distribution.")
  }
  return(round(power, 4))
} # End calc_pwr_conj_test_2sided_T()
