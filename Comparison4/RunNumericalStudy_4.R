...
ggsave(filename = "./Comparison4/Results4/PowerDensity_4.png",
       plot = powerDensity,
       width  = 5000, height = 3000, units  = "px")
...
write.csv(power15_table_summary,
          file = "./Comparison4/Results4/BONFvsCONJ/BONFvsCONJ_cases_4.csv")
write.csv(power15_diffs_table,
          file = "./Comparison4/Results4/BONFvsCONJ/BONFvsCONJ_diffs_4.csv")
...
write.csv(power35_table_summary,
          file = "./Comparison4/Results4/W1DFvsCONJ/W1DFvsCONJ_cases_4.csv")
write.csv(power35_diffs_table_summary,
          file = "./Comparison4/Results4/W1DFvsCONJ/W1DFvsCONJ_diffs_4.csv")
